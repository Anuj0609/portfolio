export const AboutMe = () => {
  return (
    <div className="flex flex-col justify-center items-center mt-28 space-y-1">
      <h1 className="font-semibold  text-6xl font-poppins">ABOUT ME</h1>
      <div className="tracking-[0.5em] text-transparent font-light pb-5 bg-clip-text bg-gradient-to-r from-blue-500 to-green-400 text-xl">
        EXPLORE NOW
      </div>
      ...
      <p className="w-[720px] text-center">
        ...
        web development, my expertise centers around React, Next.js, and modern
        web technologies, where I seamlessly blend technology with innovation.
        <br />
        <br />
